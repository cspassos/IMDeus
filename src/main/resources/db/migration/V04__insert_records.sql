...
insert into pessoa(celular, cpf, email, nascimento, nome, criacao) values ('99346554', '04488289100', 'jhonatan@gmail.com', current_date(), 'Jhonatan', 	STR_TO_DATE('1-01-2012 00:00:00', '%m-%d-%Y %H:%i:%s'));
insert into pessoa(celular, cpf, email, nascimento, nome, criacao) values ('99346565', '04488289101', 'paulo@gmail.com', 	current_date(), 'Paulo', 	STR_TO_DATE('1-01-2007 00:00:00', '%m-%d-%Y %H:%i:%s'));
insert into pessoa(celular, cpf, email, nascimento, nome, criacao) values ('91111154', '04488289102', 'douglas@gmail.com', 	current_date(), 'Douglas', 	STR_TO_DATE('1-01-2016 00:00:00', '%m-%d-%Y %H:%i:%s'));
insert into pessoa(celular, cpf, email, nascimento, nome, criacao) values ('99326554', '04488289103', 'lucas@gmail.com', 	current_date(), 'Lucas', 	STR_TO_DATE('1-01-2014 00:00:00', '%m-%d-%Y %H:%i:%s'));
insert into pessoa(celular, cpf, email, nascimento, nome, criacao) values ('11234454', '04488289104', 'maria@gmail.com', 	current_date(), 'Maria', 	STR_TO_DATE('1-01-2013 00:00:00', '%m-%d-%Y %H:%i:%s'));
insert into pessoa(celular, cpf, email, nascimento, nome, criacao) values ('91547894', '04488289105', 'joao@gmail.com', 	current_date(), 'Joao', 		STR_TO_DATE('1-01-2011 00:00:00', '%m-%d-%Y %H:%i:%s'));
insert into pessoa(celular, cpf, email, nascimento, nome, criacao) values ('91146214', '04488289106', 'adriane@gmail.com', 	current_date(), 'Adriane', 	STR_TO_DATE('1-01-2011 00:00:00', '%m-%d-%Y %H:%i:%s'));
insert into pessoa(celular, cpf, email, nascimento, nome, criacao) values ('91146264', '04488289107', 'pabline@gmail.com', 	current_date(), 'Pabline', 	STR_TO_DATE('1-01-2000 00:00:00', '%m-%d-%Y %H:%i:%s'));
insert into pessoa(celular, cpf, email, nascimento, nome, criacao) values ('99342144', '04488289108', 'melia@gmail.com', 	current_date(), 'Melia', 	STR_TO_DATE('1-01-2015 00:00:00', '%m-%d-%Y %H:%i:%s'));	
